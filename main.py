...
parser.add_argument('--dataroot', type=str, default='../dataset/fashion_mnist/', help='dataset_name')
...
parser.add_argument('--train_print_freq', type=int, default=60000, help='The number of image_print_freq') #### 1000
parser.add_argument('--valid_print_freq', type=int, default=11000, help='The number of image_print_freq') #### 1000
...
parser.add_argument('--L1_loss', type=float, default=10.0, help='Weight about L1_weight')
