...
def create_optimier(model=None,args=None):
    ...
    optimizer_CAE = optim.Adam(model[0].parameters(),lr=args.lr,betas=(0.5,0.999))
    ...
    optimizer = [optimizer_CAE]#[optimizer_Encoder, optimizer_Decoder]#, optimizer_N_Dis]#, optimizer_AN_Dis,optimizer_classifier]
